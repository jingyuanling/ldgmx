...
window.lCalendar = (function() {
	...
	MobileCalendar.prototype = {
		init: function(params) {
			...
			this.bindEvent(this.type,this.notPara);
		},
		bindEvent: function(type,notPara) {
			var _self = this;
			//呼出日期插件
			function popupDate(e) {
				_self.gearDate = document.createElement("div");
				_self.gearDate.className = "gearDate";
				var str = '<div class="date_ctrl slideInUp">' +
								'<div class="date_btn_box">' +
									'<div class="date_btn lcalendar_cancel">查看全部</div>' +
								...
								'<div class="date_roll_mask">' +
									'<div class="date_roll">' +
										...
										'<div>' +
											...
											'<div class="date_grid date_grid2">' +
												'<div>月</div>' +
											'</div>' +
										'</div>';
				if(notPara!='day'){
...
//				date_dd = date_dd > 9 ? date_dd : '0' + date_dd;
				...
				$("#data-text").val((date_yy % passY + _self.minY) + "-" + date_mm);
